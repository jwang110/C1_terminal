...
class AlgoStrategy(gamelib.AlgoCore):
    ...
    def produce_strategy_list(self, game_state):
        '''
        :param game_state:
        :return: list of possible strategies for search algorithm to process
        '''
        self.current_state_map = game_state.game_map.copy()
